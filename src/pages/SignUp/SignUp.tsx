...
import { MemberCreateDto } from '~/types/common.dto';
...
const SignUp = () => {
  ...
  const validationSchema = Yup.object({
    ...
    hospitalId: Yup.number().required('병원 ID를 입력해주세요'),
    hospitalType: Yup.string().required('병원 유형을 선택해주세요'),
  ...
  const handleSubmit = async (
    ...
    createMember(values as MemberCreateDto, {
      onSuccess: () => {
        alert('회원가입이 완료되었습니다.');
        navigate('/');
      },
