...
import { useGlobalPerformanceStatisticQuery } from '~/lib/hooks/useApi';
import CircleBadge from './CircleBadge';

const GlobalPerformanceStatistics = () => {
  const { data: performanceStatistic } = useGlobalPerformanceStatisticQuery();
...
export default GlobalPerformanceStatistics;
